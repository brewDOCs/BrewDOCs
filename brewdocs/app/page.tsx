...
export default function Home() {
  return (
    <main className="flex min-h-screen flex-col items-center justify-between p-24">
      <div className={"md:mr-auto font-bold text-7xl border-2 border-red-500 text-stone-600"}>
        <h1 className="line-clamp-1">Welcome To BrewDocs</h1>
      </div>

      <div className="mb-32 grid text-center lg:max-w-4xl lg:w-full lg:mb-0 lg:grid-cols-3 lg:text-center">
        <a
          href=""
